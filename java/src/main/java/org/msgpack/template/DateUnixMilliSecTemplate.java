...
/**
 * Serialize date class to long that is elapsed milli seconds from Unix time.
 * User: takeshita
 * Date: 11/03/08
 * Time: 17:56
 * To change this template use File | Settings | File Templates.
 */
public class DateUnixMilliSecTemplate extends DateTemplate{
	
	
	
	public DateUnixMilliSecTemplate(){}

    public Object convert(MessagePackObject messagePackObject, Object o) throws MessageTypeException {
        return new Date(messagePackObject.asLong());
    }

    public void pack(Packer packer, Object o) throws IOException {
        try{
		    packer.packLong(((Date)o).getTime());
